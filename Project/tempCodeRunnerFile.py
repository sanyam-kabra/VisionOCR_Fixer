...
import pytesseract
pytesseract.pytesseract.tesseract_cmd = 'C:\\Users\\sanya\\Downloads\\tess.exe'
...
final_image = process_image('Test_image/TestImage2.webp')  # Provide your image path here
